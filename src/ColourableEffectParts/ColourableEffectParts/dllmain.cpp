...
void Initialize()
{
	...
	//  - Add new space tools
	//  - Change materials
	new ColourableEffectsSystem();
	CheatManager.AddCheat("UpdateCreatureEffects", new UpdateAllEffectsCheat());
}
...
void AttachDetours()
{
	...
	SetEditorModeDetour::attach(GetAddress(Editors::cEditor, SetActiveMode));
